...
#define ReplaceUIElementCommand "替换用户界面元素..."
#define ReplaceUIElementDescription u8"用另一个用户界面元素替换当前的用户界面元素。"

#define CopyUIElementCommand "复制用户界面元素"
#define CopyUIElementDescription u8"复制当前用户界面元素当 Windows 剪贴板。"

#define PasteUIElementCommand "粘贴用户界面元素"
#define PasteUIElementDescription u8"用 Windows 剪贴板内容替换当前用户界面元素。"

#define CutUIElementCommand "剪切用户界面元素"
#define CutUIElementDescription u8"将当前用户界面元素复制到 Windows 剪贴板并将其替换为空的用户界面元素。"

#define AddNewUIElementCommand "添加新的用户界面元素..."
#define AddNewUIElementDescription u8"用新的用户界面元素替换已选定的空白空间。"
